...
public class TC_RF_007 {
	...
	public void verifyNavigatingToRegisterAccountUsingMultipleWay() {
		...
		driver.findElement(By.xpath("//a[normalize-space()='Continue']\r\n")).click(); //uses selectorhub for this Xpath with normalize space().
		Assert.assertTrue(driver.findElement(By.xpath("//ul[@class='breadcrumb']//a[text()='Register']")).isDisplayed());
		
		driver.findElement(By.xpath("//span[text()='My Account']")).click();
		driver.findElement(By.linkText("Login")).click();
		driver.findElement(By.xpath("//a[@class='list-group-item'][normalize-space()='Register']")).click(); //uses selectorhub
